...
public final class Tg2vkMapperUtils {
    ...
    public static Map<String, Object> createPrivateMessageContext(com.vk.api.sdk.objects.users.User profile, Message message) {
    ...
    public static Map<String, Object> createGroupMessageContext(com.vk.api.sdk.objects.users.User profile, Message message) {
